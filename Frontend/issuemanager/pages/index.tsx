              ...
              <form action="">
                ...
                <div className="flex flex-col items-center mb-3">
                  ...
                  <input
                    ...
                    className="m-1 rounded-xl border-none w-64 p-4 disabled  focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
                      ...
                      focus:invalid:border-pink-500 focus:invalid:ring-pink-500 border border-slate-300  text-sm shadow-sm placeholder-slate-400 bg-gray-100  outline-none flex-1 "
                  />
                  {/* </div> */}
                </div>
                {/* password container */}
                <div className="flex flex-col items-center mb-3">
                  <input
                    ...
                    className="m-1 rounded-xl border-none w-64 p-4 disabled  focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
                      disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
                      invalid:border-pink-500 invalid:text-pink-600 mb-3
                      focus:invalid:border-pink-500 focus:invalid:ring-pink-500 border border-slate-300  text-sm shadow-sm placeholder-slate-400 bg-gray-100  outline-none flex-1 "
                  />
                  ...
                  <button className="text-bold bg-sky-400 hover:bg-sky-600 rounded-xl w-64 p-3 m-4">
                    Save changes
                  </button>
                </div>
              </form>
